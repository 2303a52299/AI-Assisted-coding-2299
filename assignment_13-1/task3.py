''' Refactoring Using Classes and Methods (Eliminating Redundant Conditional Logic)
...
class GradeCalculator:
    ...
    This class provides a method to determine the grade corresponding to a given mark
    according to predefined grading criteria.
    """
    ...
    def calculate_grade(self, marks):
        ...
        Parameters:
        marks (int): The marks obtained by the student. Expected to be in the range 0-100.
        
        Returns:
        str: The grade corresponding to the marks, which can be one of:
             - "Grade A" for marks between 90 and 100
             - "Grade B" for marks between 80 and 89
             - "Grade C" for marks between 70 and 79
             - "Grade D" for marks between 40 and 69
             - "Fail" for marks between 0 and 39
        """
